...
public class TestWorldToCameraTransformer {
    ...
    public void constructorOkThetaZero()  {
       ...
       // System.out.println("mediator.getM() = " + mediator.getM());
        ...
        Assert.assertTrue(wtct.getVectorBetweenCameraAndWorldOrigo(mediator.getTheta(), mediator.getGamma(), mediator.getParValue("R")).equals(rDesired));
...
//        Assert.assertEquals(-1,wtct.getM().getElementAsFloat(0,0), DELTA);
    ...
    public void constructorOkThetaPiDiv4()  {
        ...
        wtct.setMediator(mediator);
        System.out.println("wtct.getR() = " + wtct.getVectorBetweenCameraAndWorldOrigo(mediator.getTheta(), mediator.getGamma(), mediator.getParValue("R")));
      //  System.out.println("wtct.getM() = " + wtct.getM());

        System.out.println("wtct.getrVector(mediator.getTheta(), mediator.getR()) = " + wtct.getVectorBetweenCameraAndWorldOrigo(mediator.getTheta(), mediator.getGamma(), mediator.getParValue("R")));
